#
#  Be sure to run `pod spec lint RBN-iOS-SDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   You can find everything you want to know on our homepage. RBN-iOS-SDK is a
                   * iBeacons
                   * Statistics
                   * Advertising
                   DESC

  s.homepage     = "https://github.com/WeLikeDigital/RBN-iOS-SDK"
  ...
  s.author             = { "Darius" => "manaev@me.com" }
  # Or just: s.author    = "darius"
  # s.authors            = { "darius" => "manaev@me.com" }
  # s.social_media_url   = "http://twitter.com/darius"
